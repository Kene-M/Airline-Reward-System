/**
 * This class represents a Sub-Tier for every Passenger that
 * is a Platinum Tier member by the end of the year and did not
...
public class PlatinumPro extends Platinum {
     ...
     */
    public PlatinumPro(int numCancFlights, int numFlights) {
